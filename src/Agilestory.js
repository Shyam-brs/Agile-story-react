                ...
                <div className="p-3">
                  <div className="card">
                    <div className="card-header">
                      Priority: {priorityList[issue.priority]}{" "}
                      <span
                        className={`mx-4 badge ${
                          issue.storyStatus === "open"
                            ? "bg-primary"
                            : "bg-danger"
                        }`}
                      >
                        {issue.storyStatus === "open" ? "open" : "closed"}
                      </span>
                    </div>
                    <div className="card-body">
                      ...
                      <p className="text-start pb-1">
                        Assigned to : {assignedToList[issue.assignedTo]}
                      </p>
